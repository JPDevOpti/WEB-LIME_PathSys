<!--
  ...
  Permite buscar muestras, pacientes o análisis.
-->
<template>
    ...
    <form @submit.prevent="handleSearch">
      <div class="relative">
        ...
        <input
          v-model="searchQuery"
          type="text"
          placeholder="Buscar muestra, paciente o análisis..."
        ...
        <button
          type="button"
          @click="handleSearch"
          class="absolute right-2.5 top-1/2 inline-flex -translate-y-1/2 items-center gap-0.5 rounded-lg border border-gray-200 bg-gray-50 px-[7px] py-[4.5px] text-xs -tracking-[0.2px] text-gray-500 dark:border-gray-800 dark:bg-white/[0.03] dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors duration-200"
        >
          <span> ⌘ </span>
          <span> K </span>
        </button>
