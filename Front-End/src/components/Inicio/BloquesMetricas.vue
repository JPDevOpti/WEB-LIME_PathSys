<!--
  ...
  Soporta tema oscuro y efectos de hover.
-->
<template>
  <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6">
    <!-- Tarjeta de Pacientes -->
    <div
      class="group rounded-2xl border border-gray-200 bg-white p-5 transition-all duration-300 hover:shadow-lg hover:border-primary-500 dark:border-gray-800 dark:bg-white/[0.03] dark:hover:border-primary-400 md:p-6"
    >
      <!-- Icono con fondo y efectos hover -->
      <div
        class="flex items-center justify-center w-12 h-12 bg-gray-100 rounded-xl transition-colors duration-300 group-hover:bg-primary-50 dark:bg-gray-800 dark:group-hover:bg-primary-900/20"
      >
        <svg
          class="fill-gray-800 transition-colors duration-300 group-hover:fill-primary-600 dark:fill-white/90 dark:group-hover:fill-primary-400"
          width="24"
          height="24"
          viewBox="0 0 24 24"
          fill="none"
      ...
      <div class="flex items-end justify-between mt-5">
        ...
        <span
          class="flex items-center gap-1 rounded-full bg-success-50 py-0.5 pl-2 pr-2.5 text-sm font-medium text-success-600 transition-all duration-300 hover:bg-success-100 dark:bg-success-500/15 dark:text-success-500 dark:hover:bg-success-500/25"
        >
          <svg
    ...
    >
      ...
      <div class="flex items-end justify-between mt-5">
        ...
        <!-- Indicador de porcentaje con animación -->
        <span
          class="flex items-center gap-1 rounded-full bg-error-50 py-0.5 pl-2 pr-2.5 text-sm font-medium text-error-600 transition-all duration-300 hover:bg-error-100 dark:bg-error-500/15 dark:text-error-500 dark:hover:bg-error-500/25"
        >
          <svg
            class="fill-current animate-bounce"
            width="12"
