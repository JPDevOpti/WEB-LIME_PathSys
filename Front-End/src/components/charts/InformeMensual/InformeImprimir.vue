...
<template>
  <div class="space-y-6">
    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:space-x-6 space-y-2 sm:space-y-0">
      ...
      <select v-model="selectedYear" id="anio" class="border rounded px-4 py-2 focus:ring focus:border-brand-500 w-full sm:w-auto">
    ...
    <div v-if="selectedMonth !== null" class="overflow-x-auto mt-6">
      <div class="mb-4">
        <h2 class="text-xl font-bold text-brand-700 mb-2">Pacientes por entidad - {{ monthsFull[selectedMonth] }} {{ selectedYear }}</h2>
      </div>
...
// import VueApexCharts from 'vue3-apexcharts' // Eliminado porque ya no se usa
