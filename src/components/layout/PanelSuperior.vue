<!--
  ...
  Incluye logo, búsqueda, notificaciones y menú de usuario.
-->
<template>
  <header
    class="sticky top-0 flex w-full bg-white border-gray-200 z-99999 dark:border-gray-800 dark:bg-gray-900 lg:border-b transition-colors duration-200"
  >
    <div class="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
      ...
      >
        <button
          @click="handleToggle"
          class="flex items-center justify-center w-10 h-10 text-gray-500 border-gray-200 rounded-lg z-99999 dark:border-gray-800 dark:text-gray-400 lg:h-11 lg:w-11 lg:border hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors duration-200"
          :class="[
            isMobileOpen
        ...
        <button
          ...
          class="flex items-center justify-center w-10 h-10 text-gray-700 rounded-lg z-99999 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 lg:hidden transition-colors duration-200"
      ...
      <div
        :class="[
          isApplicationMenuOpen ? 'flex animate-slideDown' : 'hidden',
